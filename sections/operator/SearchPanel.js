...
const styles = {
  ...
  resultsIntro: {
    ...
    flexBasis: '100%',
    width: '100%',
    marginTop: 'clamp(0.5rem, 1.4vw, 1rem)',
  },
            ...
            <section style={styles.grid} className="search-panel-grid">
              {rows.map((ath) => {
                ...
                const metaItemStyle = isCompactLayout
                  ? { ...styles.metaItem, fontSize: '.85rem' }
                  : styles.metaItem;
                ...
                if (isCompactLayout) {
                  ...
                  tagsAndActionStyle.alignItems = 'flex-start';
                  ...
                  profileBtnRowStyle.alignItems = 'flex-start';
                          ...
                          <div style={profileBtnRowStyle} className="search-panel-profile-btn-row">
                            {isUnlocked && (
                              <div
                                ...
                                aria-live="polite"
                              >
                                Unlocked ✓ — expires {formatExpiry(expiresAt) || '—'}
                              </div>
                            )}
                            <a
