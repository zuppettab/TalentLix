...
export default function Home() {
  ...
  return (
    <div style={styles.background}> {/* 👈 Background a schermo intero */}
...
const styles = {
  background: {
    backgroundImage: "url('/BackG.png')", // 👈 percorso corretto
  ...
  overlay: {
    backgroundColor: 'rgba(255, 255, 255, 0.7)', // 👈 effetto schiarito/trasparente
    width: '100%',
    height: '100%',
    position: 'absolute',
    top: 0,
